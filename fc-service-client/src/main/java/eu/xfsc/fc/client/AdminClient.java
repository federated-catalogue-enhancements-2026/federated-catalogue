...
public class AdminClient extends ServiceClient {
    ...
    /** Gets asset type restriction configuration. */
    public AssetTypeConfig getAssetTypeConfig(OAuth2AuthorizedClient authorizedClient) {
        return doGet("/admin/asset-types", Map.of(), null, AssetTypeConfig.class, authorizedClient);
    }

    /** Updates asset type restriction configuration. */
    public void updateAssetTypeConfig(AssetTypeConfig config,
        OAuth2AuthorizedClient authorizedClient) {
        doPut("/admin/asset-types", config, Map.of(), null, Void.class, authorizedClient);
    }

    /** Gets distinct asset types from stored assets. */
    public List<String> getExistingAssetTypes(OAuth2AuthorizedClient authorizedClient) {
        return doGet("/admin/asset-types/existing", Map.of(), null,
            new ParameterizedTypeReference<List<String>>(){}, authorizedClient);
    }
