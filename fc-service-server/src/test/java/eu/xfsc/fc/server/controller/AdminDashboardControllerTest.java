...
public class AdminDashboardControllerTest {
  ...
  void getAdminStats_withAdminRole_returnsAllFields() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.get("/admin/stats")
            .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.totalAssets").value(isA(Number.class)))
        .andExpect(jsonPath("$.activeAssets").value(isA(Number.class)))
        .andExpect(jsonPath("$.activeTrustFrameworks").value(isA(Number.class)))
        .andExpect(jsonPath("$.totalUsers").value(isA(Number.class)))
        .andExpect(jsonPath("$.totalSchemas").value(isA(Number.class)))
        .andExpect(jsonPath("$.totalParticipants").value(isA(Number.class)))
        .andExpect(jsonPath("$.graphClaimCount").value(isA(Number.class)))
