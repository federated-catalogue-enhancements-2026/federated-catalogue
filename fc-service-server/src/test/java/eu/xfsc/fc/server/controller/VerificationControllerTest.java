...
public class VerificationControllerTest {
  ...
  /** (CAT-FR-SF-04) POST /verification with verifySchema=true rejects a SHACL-invalid SD. */
  @Test
  ...
  /** (CAT-FR-SF-04) POST /verification with verifySchema=false accepts a SHACL-invalid SD. */
  @Test
