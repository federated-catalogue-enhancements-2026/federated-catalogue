  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
      ...
      .authorizeHttpRequests(authorization -> authorization
          ...
          // Asset Type Admin APIs
          .requestMatchers(HttpMethod.GET, "/admin/asset-types", "/admin/asset-types/existing").hasRole(ADMIN_ALL)
          .requestMatchers(HttpMethod.PUT, "/admin/asset-types").hasRole(ADMIN_ALL)
